...
export function makeTaskScreen({ containerEl, rule, showRule, contextIcon, contextLabel, onComplete }) {
    ...
    function handleTap(tileId) {
        ...
        if (rule.isValid(tile, board)) {
            ...
            boardEl.querySelector(`.tile[data-id="${tileId}"]`)?.classList.add("cleared");
